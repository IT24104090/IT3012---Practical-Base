        ...
        for x in range(self.width):
            for y in range(self.height):
                ...
                if (
                    ...
                    available_trap_positions.append(pos_tuple)

        # Create 5 toxic traps
        num_traps = min(5, len(available_trap_positions))

        self.toxic_traps = set(
            random.sample(available_trap_positions, num_traps)
        )
